            ...
            >
                ...
                <div className="h-full hidden lg:flex">
                    ...
                    <div className="w-72 bg-[var(--t-bg-2)] border-r border-[var(--t-border)] p-6 flex flex-col">
                        <div className="mb-6">
                            <Image src="/new-light-logo.png" alt="VG Salon" width={44} height={44} className="w-auto" />
                        </div>
                ...
                <div className="h-full flex flex-col lg:hidden overflow-x-hidden">
                    ...
                    <div className="flex-shrink-0 bg-[var(--t-bg-2)] border-b border-[var(--t-border)] px-4 py-3">
                        <div className="flex items-center justify-between mb-2">
                            <Image src="/new-light-logo.png" alt="VG Salon" width={30} height={30} className="w-auto" />
