...
CREATE TABLE public.profiles (
  ...
  CONSTRAINT profiles_org_role_id_fkey FOREIGN KEY (org_role_id) REFERENCES public.organization_roles(id)
);
...
CREATE TABLE public.birthday_message_sends (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  customer_id uuid NOT NULL,
  organization_id uuid NOT NULL,
  birthday_year integer NOT NULL,
  status text NOT NULL DEFAULT 'processing'::text CHECK (status = ANY (ARRAY['processing'::text, 'sent'::text, 'failed'::text])),
  ...
  CONSTRAINT birthday_message_sends_pkey PRIMARY KEY (id),
  CONSTRAINT birthday_message_sends_customer_year_key UNIQUE (customer_id, birthday_year),
  CONSTRAINT birthday_message_sends_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id),
  CONSTRAINT birthday_message_sends_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
...
CREATE TABLE public.staff (
  ...
  CONSTRAINT staff_org_role_id_fkey FOREIGN KEY (org_role_id) REFERENCES public.organization_roles(id)
);
...
CREATE TABLE public.staff_earnings (
  ...
  CONSTRAINT staff_earnings_invoice_id_fkey FOREIGN KEY (invoice_id) REFERENCES public.invoices(id),
  CONSTRAINT staff_earnings_appointment_id_fkey FOREIGN KEY (appointment_id) REFERENCES public.appointments(id)
);
...
CREATE TABLE public.petty_cash_transactions (
  ...
  updated_at timestamp with time zone DEFAULT now(),
  organization_id uuid NOT NULL,
  entry_type text NOT NULL DEFAULT 'petty_cash'::text CHECK (entry_type = ANY (ARRAY['petty_cash'::text, 'expense'::text])),
  ...
  CONSTRAINT petty_cash_transactions_expense_category_id_fkey FOREIGN KEY (expense_category_id) REFERENCES public.expense_categories(id)
);
...
CREATE TABLE public.organization_roles (
  ...
  can_earn_commission boolean NOT NULL DEFAULT false,
  is_bookable boolean NOT NULL DEFAULT false,
  can_manage_staff boolean NOT NULL DEFAULT false,
  can_manage_settings boolean NOT NULL DEFAULT false,
  can_view_all_earnings boolean NOT NULL DEFAULT false,
